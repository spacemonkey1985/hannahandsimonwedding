	...
	**/
	$("#maps").gmap3({
		 map:{
 		 ...
 		 marker:{
 		 	values : [
 		 		{latLng:[52.947014, -1.436021],data:'<img src="https://dl.dropboxusercontent.com/u/29545616/Preview/ditinggalrabi.png">',  options:{icon: 'https://dl.dropboxusercontent.com/u/29545616/Preview/location.png'}}
 		 	],
 		 	events : {
